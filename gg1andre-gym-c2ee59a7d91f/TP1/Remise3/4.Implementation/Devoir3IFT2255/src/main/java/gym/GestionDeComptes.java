...
public class GestionDeComptes {
	...
	public boolean newMember(){	
            ...
            Membre nouveauMembre = new Membre(prenom, nom, "mm/jj/aaaa", adresse, "xxxxxxxxxx", email, fraisAdhesionMensuel, fraisAPayer, statutMembre, numeroMembre);
            nouveauMembre.setDateDeNaissance();
            nouveauMembre.setNumeroDeTel();
    ...
    public boolean newProfessionnel(){    	
	    ...
	    Professionnel nouveauProfessionnel = new Professionnel(prenom, nom, "mm/jj/aaaa", adresse, "xxxxxxxxxx", email, numeroProfessionnel);
	    nouveauProfessionnel.setDateDeNaissance();
	    nouveauProfessionnel.setNumeroDeTel();
	    
	    listeProfessionnels.add(nouveauProfessionnel);
